 ...
 */
function parseGen1Save(buffer, filename = "save.sav") {
    const view = buffer;
    ...
    return {
        ...
        isValid: isValid,
        trainer: { name, id, money, coins, playTime, badges: badgeNames, rivalName, pikachuFriendship, gender: 'Male' },
        options,
        map: mapData,
 ...
 */
function isGen1Save(arrayBuffer) {
 ...
 */
async function detectAndParseSave(file) {
    try {
...
window.parseGen1Save = parseGen1Save;
window.isGen1Save = isGen1Save;
window.detectAndParseSave = detectAndParseSave;

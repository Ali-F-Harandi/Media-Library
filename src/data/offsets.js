...
export const GEN1_OFFSETS = {
  ...
  // Rival's name offset (alternative location)
  RIVAL_NAME_ALT: 0x25A3,
};

// Internal Pokémon ID to National Dex mapping for Gen 1
// Gen 1 uses internal IDs that don't match the National Dex order
...
// Reverse mapping: National Dex to Gen 1 Internal ID
export const GEN1_DEX_TO_INTERNAL = {};
Object.entries(GEN1_INTERNAL_TO_DEX).forEach(([internal, dex]) => {
  if (dex > 0) {
    GEN1_DEX_TO_INTERNAL[dex] = parseInt(internal);
  }
});
